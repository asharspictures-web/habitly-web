    ...
    <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          {premiumPlan && (
            <div className={`relative rounded-2xl p-6 shadow-xl overflow-hidden ${tier === 'premium' ? 'bg-gradient-to-br from-[#18181b] to-amber-900/10 border border-amber-500/50' : 'bg-gradient-to-br from-[#18181b] to-[#27272a]/20 border border-[#27272a]'}`}>
              <div className={`absolute top-0 right-0 text-[10px] uppercase font-black tracking-widest px-3 py-1 rounded-bl-xl z-30 ${tier === 'premium' ? 'bg-amber-500 text-black' : 'bg-zinc-700 text-white'}`}>
                Premium Plan
              </div>
              ...
              {tier !== 'premium' && (
                <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-black/50 backdrop-blur-[4px]">
                  ...
                  <button 
                    ...
                    className="bg-amber-500 hover:bg-amber-600 text-black font-bold px-6 py-2.5 rounded-xl transition-colors shadow-lg"
                  >
                    Upgrade Now
                  </button>
                </div>
              ...
              </div> {/* Close blurred content wrapper */}
            </div>
          )}
