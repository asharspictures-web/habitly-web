...
export default function HomePage({ onNavigate }) {
  return (
    <div className="animate-in fade-in duration-700 min-h-screen flex flex-col w-full">
      ...
      <div className="relative w-full min-h-[85vh] flex flex-col pb-16">
        {/* Background Image (Cover, Centered Focal Point) */}
        <div 
          className="absolute inset-0 z-0 bg-cover bg-center" 
          style={{ backgroundImage: 'url(/hero-bg.jpg)' }} 
        />
        {/* Flat Dark Neutral Overlay (75% opacity) - NO RED TINT */}
        <div className="absolute inset-0 z-0 bg-[#09090b]/75" />

        {/* Content Container (Constrained Width) */}
        <div className="relative z-10 w-full max-w-6xl mx-auto px-4 md:px-8 flex flex-col flex-1">
          ...
          <div className="flex items-center justify-between py-6 w-full">
            ...
            <div className="flex items-center space-x-4">
              <button 
                ...
                className="text-sm font-bold text-zinc-300 hover:text-white transition-colors drop-shadow-md"
              >
                Pricing
              </button>
              <button 
          ...
          {/* Hero Content */}
          <div className="flex-1 flex flex-col justify-center items-center text-center mt-8 mb-12">
